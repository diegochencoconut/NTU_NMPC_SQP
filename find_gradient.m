function [grad_cost, grad_state] = find_gradient(input, delta, start_state, input_size, state_size, Ts, Q, R, N)
    ...
    for i = 1:N*input_size
        ...
        temp_cost_plus = cost_function(temp_state_plus, temp_input_plus, Q, R, N);
        temp_cost_minus = cost_function(temp_state_minus, temp_input_minus, Q, R, N);
